...
import ma.enset.productsapp.sec.KeycloakSecurityConfig;
...
public class ProductController{
    ...
    public String suppliers(Model model){
        PagedModel<Supplier> pageSuppliers = keycloakRestTemplate
                .getForObject("http://localhost:8083/suppliers",
                PagedModel.class);
